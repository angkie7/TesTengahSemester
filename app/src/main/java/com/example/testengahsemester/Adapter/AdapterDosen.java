...
import com.example.testengahsemester.CreateDosen;
import com.example.testengahsemester.Model.Dosen;
...
public class AdapterDosen extends RecyclerView.Adapter<AdapterDosen.ViewHolder> {
    ...
    public  AdapterDosen (ArrayList<Dosen> dataList){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.cv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(context !=null) {
                    Intent intent = new Intent(context, CreateDosen.class);
